...
\noindent\includegraphics[width=\linewidth]{_img/places/jebble.jpg}
...
\subsection{En route}
\noindent\includegraphics[width=\linewidth]{_img/places/jebble-cave.jpg}
...
\begin{figure}[!h]
	...
	\begin{tikzpicture}[overlay, anchor=north]
		\node at (0,0) {\includegraphics[height=0.94\textheight]{_img/places/labo-pulsipher-map.jpg}};
		\node at (0,-0.4) {\includegraphics[height=0.89\textheight]{_img/places/labo-pulsipher-layers.png}};
	\end{tikzpicture}
\end{figure}
