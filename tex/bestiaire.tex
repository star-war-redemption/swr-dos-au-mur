...
\subsection{Rakghoul}
\label{sec:rakghoul}
\noindent\includegraphics[width=\linewidth]{_img/bestiary/rakghoul.png}
...
\newpage
\subsection{AT-ST} \label{sec:at-st}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{_img/bestiary/atst.png}
\end{figure}
